...
class Join(RelationalOperand):
    ...
    def __init__(self, arg1, arg2, left=False):
        ...
        self._arg1 = Subquery(arg1) if isinstance(arg1, Projection) or arg1.restrictions else arg1
        self._arg2 = Subquery(arg2) if isinstance(arg2, Projection) or arg2.restrictions else arg2
