...
class Connection:
    ...
    def __init__(self, host, user, passwd, init_fun=None):
        ...
        self._conn = sql_api.connect(init_command=init_fun, **self.conn_info)
    ...
    def query(self, query, args=(), as_dict=False):
        ...
        :param args: additional arguments for the sql_api.cursor
        :param as_dict: If as_dict is set to True, the returned cursor objects returns
                        query results as dictionary.
        """
        cursor = sql_api.cursors.DictCursor if as_dict else sql_api.cursors.Cursor
