...
because it circumvents data dependency constraints.
...
values ensures the integrity of the data throughout the pipeline.

This approach applies specifically to automated tables
(see [Auto-populated tables](populate.md)).
