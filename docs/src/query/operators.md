...
Why join compatibility restrictions?
...
```python
Session & 'user = "Alice"' # All the sessions performed by Alice
Session & 'session_date >= "2022-01-01"' # All of the sessions on or after January 1st, 2022
```
