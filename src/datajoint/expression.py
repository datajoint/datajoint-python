...
class QueryExpression:
    ...
    def __mul__(self, other: QueryExpression | type[QueryExpression]) -> QueryExpression:
        """
    ...
    def __matmul__(self, other: QueryExpression | type[QueryExpression]) -> QueryExpression:
        """
        The @ operator has been removed in DataJoint 2.0.
        Use .join(other, semantic_check=False) for permissive joins.

        :param other: QueryExpression (unused - raises error)
        :raises DataJointError: Always raises to indicate deprecation
        """
        raise DataJointError(
    ...
    def __add__(self, other: QueryExpression | type[QueryExpression]) -> QueryExpression:
        """
