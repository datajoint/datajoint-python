...
DataJoint for Python is developed and maintained by [Dimitri Yatsenko](https://github.com/dimitri-yatsenko), [Fabian Sinz](https://github.com/fabiansinz), and [Edgar Y. Walker](https://github.com/eywalker).
